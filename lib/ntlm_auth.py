...
class ntlm_auther:
    ...
    def proxy_ntlm_authentication(self, connection):
        ...
        NTLM_msg1 = ntlm_messages.create_message1(env)  #创建type1协商消息
        ...
        if auth:
            ...
            nonce = ntlm_messages.parse_message2(msg2)    #解析type2，chanallge-id消息
            NTLM_msg3 = ntlm_messages.create_message3(nonce, env)  #构造type3，response消息给ntlm服务器
